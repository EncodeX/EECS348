...
# specification of boards, gold sequences
# and game parameters used to test student code
...
game5 = [copy.deepcopy(boardD), ans4, 100, 7, 'First Move', 'AlphaBeta', 'x']
...
def test(board, max_moves, depth, algoG, algoS, student_xo):
    ...
    # instantiates student and grader players
    # based upon students' 'x' or 'o' designation
    if student_xo == 'x':
    ...
    # players continue to alternate turns until
    # gameover or maximum moves reached
    done = False
    ...
    # returns appropriate list of moves based upon
    # player's 'x' or 'o' designation
    # print "x: ", moves_x
    # print "o: ", moves_o
    if student_xo == 'x':
        return(moves_x)
...
def main():
    ...
    # loop through all individual games and compare
    # student moves with gold moves
    for i in range(len(games)):
        ...
        print "Used time: ", int(round(time.time() * 1000)) - t, "ms"
